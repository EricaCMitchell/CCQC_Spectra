...
def similarity(x, y, min_eV, max_eV):
	'''
	Computes the similarity (S) between two spectra
	based off the cosine-similarity expression
	'''
	# Change sheet_name as needed
	df = pd.read_excel('/home/vulcan/ecm23353/Research/3_AB/bin/cross-secs-Sept2021.xlsx', sheet_name="ethane")
	exp_x = df['E (eV)']
	exp_y = df['s (Mb)']	
